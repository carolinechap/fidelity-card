 ...
 */
final class Version20190710092818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, store_id INT DEFAULT NULL, statut LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', check_sum INT NOT NULL, customer_code INT DEFAULT NULL, fidelity_point INT DEFAULT NULL, INDEX IDX_161498D3A76ED395 (user_id), INDEX IDX_161498D3B092A811 (store_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE card_activity (id INT AUTO_INCREMENT NOT NULL, card_id INT NOT NULL, activity_id INT NOT NULL, is_the_winner TINYINT(1) DEFAULT NULL, personal_score INT DEFAULT NULL, INDEX IDX_1545C7D94ACC9A20 (card_id), INDEX IDX_1545C7D981C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', email VARCHAR(150) NOT NULL, password VARCHAR(255) NOT NULL, number_street INT DEFAULT NULL, name_street VARCHAR(150) DEFAULT NULL, zip_code VARCHAR(20) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, country VARCHAR(100) DEFAULT NULL, lastname VARCHAR(100) NOT NULL, firstname VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, fidelity_point INT DEFAULT NULL, game_date DATETIME DEFAULT NULL, game_name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
